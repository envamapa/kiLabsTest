...
public class CoordinateConvertions {
    public static final double RADIANS_TO_DEGREES = 180.0/Math.PI;
    public static final double DEGREES_TO_RADIANS = Math.PI/180.0;

    private CoordinateConvertions()
    {
    }
    /**
    ...
    {
        Double degrees[] = CoordinateConvertions.xyzToLatLonRadians(xyz);

        degrees[0] = degrees[0] * CoordinateConvertions.RADIANS_TO_DEGREES;
        degrees[1] = degrees[1] * CoordinateConvertions.RADIANS_TO_DEGREES;
    ...
    {
        double degrees[] = CoordinateConvertions.getXYZfromLatLonRadians(latitude * CoordinateConvertions.DEGREES_TO_RADIANS,
                longitude * CoordinateConvertions.DEGREES_TO_RADIANS,
                height);
